<?php
/**
 * Edit Event page for CommunityLink - A5 CakePHP version
 * Based on A3 events.php edit form, adapted for CakePHP with same Bootstrap styling
 * 
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?= $this->Form->create($event, ['url' => ['action' => 'edit', $event->id]]) ?>
                                        ...
                                        <?php foreach ($volunteers ?? [] as $volunteer): ?>
                                            <div class="form-check">
                                                <?= $this->Form->checkbox('volunteer_ids[]', [
                                                    ...
                                                    'checked' => in_array($volunteer->id, $assignedVolunteerIds ?? [])
                                                ]) ?>
