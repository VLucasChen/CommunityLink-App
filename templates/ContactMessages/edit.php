...
<div class="page-header">
    <div class="container">
        ...
        <p class="page-subtitle">Update contact message information</p>
    </div>
</div>

<div class="container">
    <?= $this->Form->create($contactMessage, ['class' => 'needs-validation', 'novalidate' => true]) ?>
    
    <div class="form-card">
        <!-- Validation Errors -->
        <?php if ($contactMessage->getErrors()): ?>
            <div class="alert alert-danger" role="alert">
                ...
                <ul>
                    <?php foreach ($contactMessage->getErrors() as $field => $errors): ?>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <div class="form-check">
                        <?= $this->Form->checkbox('is_replied', [
                            'class' => 'form-check-input',
                            'id' => 'is_replied'
                        ]) ?>
                        <label class="form-check-label" for="is_replied">
                            Mark as Replied
                        </label>
                    </div>
                </div>
...
<?= $this->element('success_modal', [
    'modalId' => 'editContactMessageSuccessModal',
    'title' => 'Message Updated!',
    'message' => 'The contact message has been updated successfully.',
    'actionLink' => ['action' => 'index'],
    'actionText' => 'View All Messages'
]) ?>
