<?php
/**
 * Edit Organisation - A5 layout (matches Events/Volunteers pages)
            ...
            <div class="main-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Update Organisation</button>
                        <?= $this->Form->end() ?>
                    </div>
                </div>
            </div>
