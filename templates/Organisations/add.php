...
<div class="page-header">
    <div class="container">
        ...
        <p class="page-subtitle">Create a new organisation profile</p>
    </div>
</div>
    ...
    <div class="form-card">
        ...
        <div class="form-actions">
            <button type="submit" class="btn-submit">
                <i class="bi bi-check-circle"></i> Save Organisation
            </button>
            <?= $this->Html->link(
...
<?= $this->element('success_modal', [
    'modalId' => 'addOrgSuccessModal',
    'title' => 'Organisation Created!',
    'message' => 'The organisation has been created successfully.',
