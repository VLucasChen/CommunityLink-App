<?php
/**
 * Edit User - A5 admin layout matching Events/Volunteers
                    ...
                    <div class="card-body">
                        <?= $this->Form->create($user) ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <?= $this->Form->label('password', 'New Password (leave blank to keep current)', ['class' => 'form-label']) ?>
                                        <?= $this->Form->password('password', ['class' => 'form-control', 'placeholder' => 'New Password (leave blank to keep current)', 'value' => '', 'autocomplete' => 'new-password']) ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <?= $this->Form->label('confirm_password', 'Confirm Password', ['class' => 'form-label']) ?>
                                        <?= $this->Form->password('confirm_password', ['class' => 'form-control', 'placeholder' => 'Re-enter new password', 'value' => '', 'autocomplete' => 'new-password']) ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
