...
<head>
    ...
    <title>Add New Volunteer - CommunityLink</title>
                ...
                <div class="main-content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Add New Volunteer</h5>
                        </div>
                        <div class="card-body">
                            <?= $this->Form->create($volunteer, ['url' => ['action' => 'add'], 'enctype' => 'multipart/form-data']) ?>
                                <!-- Name Fields -->
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="form-text text-muted">JPG, PNG or GIF only</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="form-text text-muted">WWCC, Police check, CV etc. combined into one PDF</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-2"></i>Add Volunteer
                                    </button>
