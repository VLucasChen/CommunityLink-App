...
<div class="page-header">
    <div class="container">
        ...
        <p class="page-subtitle">Register a new volunteer signup request</p>
    </div>
</div>
                ...
                <div class="col-md-6">
                    <div class="file-upload-area" onclick="document.getElementById('profile_picture').click()">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-2" style="font-size: 0.875rem;">Click to upload or drag and drop</p>
                            ...
                            <span id="profile_picture_name" class="text-muted" style="font-size: 0.875rem;"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="file-upload-area" onclick="document.getElementById('documents').click()">
                        ...
                        <div>
                            ...
                            <span id="documents_name" class="text-muted" style="font-size: 0.875rem;"></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const documentsName = document.getElementById('documents_name');

        if (profilePictureInput) {
            profilePictureInput.addEventListener('change', function(e) {
                if (this.files && this.files[0]) {
                    profilePictureName.textContent = 'Selected: ' + this.files[0].name;
                } else {
        ...
        if (documentsInput) {
            documentsInput.addEventListener('change', function(e) {
                if (this.files && this.files[0]) {
                    documentsName.textContent = 'Selected: ' + this.files[0].name;
                } else {
                    documentsName.textContent = '';
                }
            });
        }
